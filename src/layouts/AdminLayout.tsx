...
export const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      ...
      {/* Sidebar */}
      <aside className={`
        fixed inset-y-0 left-0 bg-white border-r border-gray-200 w-64 max-w-[80vw] flex flex-col transition-transform duration-300 z-40
      ...
      `}>
        ...
        <div className="p-4 border-t border-gray-200">
          <button
            ...
            className="flex items-center space-x-3 px-3 py-2.5 w-full text-left rounded-lg text-red-600 hover:bg-red-50 transition-colors font-medium cursor-pointer"
          >
            <LogOut size={20} />
            <span>Logout</span>
          </button>
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-y-auto p-4 sm:p-6 md:p-8 w-full max-w-full">
        <Outlet />
      </main>
    </div>
  );
